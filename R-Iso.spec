...
Version  : 0.0.18
Release  : 23
URL      : https://cran.r-project.org/src/contrib/Iso_0.0-18.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Iso_0.0-18.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571848401
